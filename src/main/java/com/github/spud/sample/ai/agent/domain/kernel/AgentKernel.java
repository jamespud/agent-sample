...
import com.github.spud.sample.ai.agent.domain.kernel.protocol.ReactJsonAction;
  ...
  private void executeAct(AgentContext ctx, StateMachine<AgentState, AgentEvent> sm,
    ...
    try {
      ...
      try {
        ...
        observationJson = JsonUtils.objectMapper().writerWithDefaultPrettyPrinter()
          .writeValueAsString(obsNode);
      } catch (Exception e) {
